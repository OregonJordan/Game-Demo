...
//Global Variables/////////////////////////////////////////////////////////////////////////////////////////////////////////
var mainBackgroundAudio;	//Main Background Music//
var battleBackgroundAudio;  //Battle Sequence Background Music//


///Villian|Health List///
var villianList;
villianList = ["Assassin", 30,
"Centipide", 25,
"Cerberus", 75,
"Psycho", 55,
"Ogre", 40,
...
function pageLoad() {
	//Background Audio//
	document.querySelector(".gameBoard_container").style.visibility = "hidden"; //turned on after player reads instructions and presses play


	mainBackgroundAudio = new Audio("./soundfx/background/backgroundSound.mp3");//Main Background Music//
	battleBackgroundAudio = new Audio("./soundfx/background/backgroundSound2.mp3");//Battle Sequence Background Music//
...
function journeyDisplayText(x, img) {
	...
	let displayText;
	if (x == 10) {
		displayText = "Drat! I didn't see that cleverly disguised trap. Wait, this guy has guns? Ok who's big idea was that....'Jordan'";
		document.querySelector("#game_message").innerHTML = displayText;
	} else if (x == 20 ) {
		displayText = "Oh common, how many legs do you need? No really, how many? I guess I'm going to have to chop you down to size you over achiever you.";
		document.querySelector("#game_message").innerHTML = displayText;
	} else if (x == 30 ) {
		displayText = "Come here you cute little doggy....What in the bojangles is that thing supposed to be? This is going to be a mess.";
		document.querySelector("#game_message").innerHTML = displayText;
	} else if (x == 40 ) {
		displayText = "Jimminy Christmas!! I think I crapped my self a tiny bit. This guy is crazy looking with that tongue. You won't like ice cream when I get through with you.";
		document.querySelector("#game_message").innerHTML = displayText;
	} else if (x == 50 ) {
		...
		displayText = "I'm so scared! Look at me shaking in my soft, fluffy, little size 9.5 boots (which is the average size shoe for males in the US).... come here you!";
		document.querySelector("#game_message").innerHTML = displayText;
	} else if (x == 80 ) {
